...
[![GitHub downloads (all assets, all releases)](https://img.shields.io/github/downloads/Alexbeav/metal-slug-x-recomp/total)](https://github.com/Alexbeav/metal-slug-x-recomp/releases)
[![GitHub downloads (latest release)](https://img.shields.io/github/downloads/Alexbeav/metal-slug-x-recomp/latest/total)](https://github.com/Alexbeav/metal-slug-x-recomp/releases/latest)
[![GitHub release](https://img.shields.io/github/v/release/Alexbeav/metal-slug-x-recomp)](https://github.com/Alexbeav/metal-slug-x-recomp/releases/latest)
<!-- /retcomm-readme-metrics -->
...
Metal Slug X recompiled for modern systems using psxrecomp.
...
Zip prefix for CI artifacts: `metal-slug-x-recomp`.
